...
public abstract class Command {
    ...
    protected static InvestmentsDao          investmentsDao         =factory.getInvestmentsDao();
    ...
    protected static OperatorsDao          operatorsDao         =factory.getOperatorsDao();
    protected static ApplicationDao         applicationDao      =factory.getApplicationDao();
    protected static PavilionDao         pavilionDao      =factory.getPavilionDao();
    protected static QuestionDao         questionDao      =factory.getQuestionDao();
    protected static QuestDao         questDao      =factory.getQuestDao();
    protected static ReminderTaskDao         reminderTaskDao      =factory.getReminderTaskDao();
    ...
    protected void    sendMessageWithAddition() throws TelegramApiException {
        ...
        timmy.entity.standart.Message message = messageDao.getMessage(messageId);
